...
class InvestReportEngine {
  constructor({
    ...
    this.valorInvestidoDolar = valorInvestidoDolar;
    this.precoCompraCriptoDolar = precoCompraCriptoDolar;
    this.precoVendaCriptoDolar = precoVendaCriptoDolar;
    this.taxaCambioRealDolar = taxaCambioRealDolar;
    this.taxaCambioRealDolarEpoca = taxaCambioRealDolarEpoca;
